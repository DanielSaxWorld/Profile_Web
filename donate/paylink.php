...
<body class="gray-bg">
    ...
    <button type="button" onClick="paylinkModal()" class="btn btn-warning m-t"><strong>Donate Now</strong></button><br><br>
			
			<a class="paylink-modal-window" href="#"
    data-href="https://https://www.paylink.ng/powerplug/pay?tid=PAYMENT-TEMPLATE-ID">
    Open modal window
</a>
