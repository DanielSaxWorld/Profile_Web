...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     ...
     <title>GOGHI || Failed Donation</title>
    <meta name="description" content="Failed | Donation" />
...
<body class="gray-bg">
    ...
    <img src="img/Transaction-Failed.fw.png" height="100"><br>
        <h3 class="font-bold">Please try donation again!</h3>

        <div class="error-desc">
        <a href="../" class="btn btn-warning m-t">Back to Homepage</a>
