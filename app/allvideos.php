            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-2">
                    <div class="title-action">
                        <a data-toggle="modal" data-target="#addvideo" class="btn btn-primary" style="float:right"><i class="fa fa-plus-circle"></i> Add Videos</a>
                    </div>
                </div>
            </div>
...
?>
                    ...
                    <tr class="gradeA">
                        ...
                        <td><?php echo $row['youtubeid']; ?></td>
                        <td><?php echo $row['date']; ?></td>
                        <td><img alt="image" class="img-circle" src="videos/<?php echo $row['image']; ?>" height="50" /></td>
                        <td><div class="btn-group">
                            <button data-toggle="dropdown" class="btn btn-primary btn-xs dropdown-toggle">Action <span class="caret"></span></button>
                            <ul class="dropdown-menu">
                            <li><a data-toggle="modal" <?php echo "href='deletevideos.php?id=".$row['id']."'"; ?> onclick="return confirm('ARE YOU SURE TO DELETE THIS VIDEO?'); ">Delete</a></li>
                            </ul>
                        </div></td>
                    </tr>
