            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-2">
                    <div class="title-action">
                        <a data-toggle="modal" data-target="#addevents" class="btn btn-primary" style="float:right"><i class="fa fa-plus-circle"></i> Add Event</a>
                    </div>
                </div>
            </div>
...
?>
                    ...
                    <tr class="gradeA">
                        ...
                        <td><?php echo $row['address']; ?>, <?php echo $row['state']; ?> <?php echo $row['country']; ?></td>
                        ...
                        <td><div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
								...
								<li><a data-toggle="modal" <?php echo "href='deleteevents.php?id=".$row['id']."'"; ?> onclick="return confirm('ARE YOU SURE TO DELETE THIS EVENT?'); ">Delete</a></li>
                            </ul>
                        </div></td>
                    </tr>
